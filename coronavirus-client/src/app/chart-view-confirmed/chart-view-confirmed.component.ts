...
@Component({
  selector: 'app-chart-view-confirmed',
  templateUrl: './chart-view-confirmed.component.html',
  styleUrls: ['./chart-view-confirmed.component.css'],
  template: '<fusioncharts width="700" height="400" type="line" [dataSource]="chartSource"></fusioncharts>'
})
export class ChartViewConfirmedComponent implements OnInit {
  timeSeriesData: any;
  chartSource: any;
